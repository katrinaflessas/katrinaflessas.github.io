...
<div class="text-center p-4">
  <img width="600px"
       src="../img/shape-calculator/shapecalculatorprojectpage.png"
       class="img-thumbnail"
       alt="Shape Calculator program output">
</div>
...
This project helped reinforce my understanding of classes, inheritance, virtual functions, and polymorphism in C++. It also gave me experience organizing related objects into a class hierarchy and using user input to control a program’s behavior. This was an individual class project, and I was responsible for implementing, testing, and documenting the program. I used AI assistance to help structure parts of the implementation, troubleshoot errors, and better understand how the classes and polymorphic methods worked together.

## Source Code

The source code is available in my [Shape Calculator GitHub repository](https://github.com/katrinaflessas/shape-calculator).
